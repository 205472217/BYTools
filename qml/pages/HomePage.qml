    ...
    ColumnLayout {
        ...
        ColumnLayout {
            ...
            TabBar {
                ...
                Repeater {
                    model: appController.pluginCategories
                    delegate: TabButton {
                        id: tabBtn
                        text: modelData
                        font.pixelSize: 13
            ...
            Flickable {
                ...
                GridLayout {
                    ...
                    Repeater {
                        model: appController.features.filter(function(f) {
                            return f.category === appController.pluginCategories[tabBar.currentIndex]
                        })
